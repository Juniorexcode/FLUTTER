...
- **[react-spline-wrapper.tsx](examples/react-spline-wrapper.tsx)** — Production-ready lazy-loaded React wrapper (reference only)
- **[vanilla-embed.html](examples/vanilla-embed.html)** — Minimal vanilla JS embed (reference only)
- **[interactive-scene.tsx](examples/interactive-scene.tsx)** — Full interactive example with events, variables, and camera (reference only)
