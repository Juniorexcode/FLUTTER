 ...
 * ============================================================================
 * This file is a reference for agents to understand the full interactive
 * Spline pattern in React/Next.js, including:
 ...
 * This is a reference implementation — agents should copy the patterns
 * they need and adapt to the target framework (e.g., Flutter Web, Vue, etc.).
 * ============================================================================
 *
 * --- CODE START ---
 *
 ...
 * const MOBILE_FALLBACK_IMAGE = '/images/scene-fallback.png';
 *
 ...
 *         console.log('Scene objects:', objects.map((o: any) => o.name));
 *
 *         // Event Listeners
 ...
 *                 }}>
 *                     <p>Active: {activeObject || 'None'}</p>
 *                     <p>Score: {score}</p>
 *                     <button onClick={() => triggerEvent('mouseDown', 'PlayButton')}>▶ Play</button>
